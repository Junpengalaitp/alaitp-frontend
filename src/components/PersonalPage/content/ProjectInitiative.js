...
const ProjectInitiative = () => (
  <div className="row">
    ...
    <div className="intro-text col-8">
      ...
      <p>
        万事开头难，在我开始自学编程和开发时，不知道从什么技术开始学起，我身边的同学朋友也没有做技术的，没有人可以去问，所以就想到让市场来决定，
      ...
      <p>
        ...
        相关的技术和实现方式。相比纯粹的技术学习，这种学习方式是更加高效的。即使在纯技术学习的过程中，当了解到了一些更好的算法、设计模式或实现方式时，
        在工作中往往由于各种限制不能立刻用到现有的代码里，但是可以立刻用到这个项目上，实时得到反馈，大大提高了学习的效率。
      </p>
