...
const ReadingHabit = () => (
  <div className="row">
    <div className="intro-text col-9">
      ...
      <p>这三类信息的质量是递增的，所以我希望获得的信息都是第二类和第三类的。虽然现在获得信息很方便，但我更偏爱读书。
        原因有两点，一是每本书自身的各章节构成了一个完整的系统，系统化的知识比碎片化的知识更容易吸收和掌握。二是虽然通过互联网也能获取不少高质量的信息，
    ...
    <div className="row">
      ...
      <img className="col-4" src={books2} alt=""/>
    </div>
    <div className="intro-text col-9">
