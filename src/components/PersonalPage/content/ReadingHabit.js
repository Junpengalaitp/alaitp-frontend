...
const ReadingHabit = () => (
  <div className="intro-text">
    <p>我对信息的获取做了三个分类，第一类：别人付出金钱想让你知道的：广告和营销。第二类：自己付出金钱才能知道的：书籍。第三类：不仅自己付出金钱，
      还需付出努力才能知道的：专业知识。这三类信息的质量是递增的，所以我希望获得的信息都是第二类和第三类的。虽然现在获得信息很方便，但我更偏爱读书。
      原因有两点，一是每本书自身的各章节构成了一个完整的系统，系统化的知识比碎片化的知识更容易吸收和掌握。二是虽然通过互联网也能获取不少高质量的
      信息，但是时常伴随着第一类信息的干扰，所以我更加偏爱读书。当然，从互联网获取信息也是很频繁的，不过通过读书培养的系统性思维，能够更好的将
      互联网上碎片化信息进行聚合，更高效的利用信息。</p>
    <img className="row" src={books1} alt=""/>
    <img className="row" src={books2} alt=""/>
    <p>在运动和上下班通勤时，我会听有声书，使用的是Amazon的Audible。</p>
